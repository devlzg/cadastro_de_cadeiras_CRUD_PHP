 <section class="produtos">
        <div class="produtos-titulo">
            ...
            <div class="btn-add-container">
                <a href="index.php"><button type="submit" class="btn-add">Voltar<i class='bx'></i></button></a>
            </div>
            <div class="btn-add-container">
                <a href="relatorioCadeiras.php"><button type="submit" class="btn-add">Gerar Relatório<i class='bx'></i></button></a>
            </div>
            <?php 
            print "<form action='?page=pesquisar' method='POST'>";
            ?>
                    <input type="hidden" name="acao" value="pesquisar">
                    <input type="text" placeholder="Digite o modelo ou fabricante..." name="cadPesquisa" id="fabricanteProduto" required>
